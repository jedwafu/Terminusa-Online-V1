"""
Fix for circular import issue in the Announcement model
"""
import os

def fix_announcement_model():
    """Fix the Announcement model to prevent circular imports"""
    # Read the current content of models/announcement.py
    with open('models/announcement.py', 'r') as f:
        content = f.read()

    # Create a new version that doesn't use the direct relationship
